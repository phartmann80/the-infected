...
The scene uses review-only primitives and proves the first small gameplay loop: movement, smoothed camera follow, one survivor, one infected, basic combat and damage, pickup inventory, a versioned local save, and a responsive touch HUD with health bars. It does not contain production characters, final weapons, economy, progression, paid content, multiplayer, or release signing.
